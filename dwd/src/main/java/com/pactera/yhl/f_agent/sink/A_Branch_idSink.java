...
/**
 * @author: TSY
 * @create: 2021/10/19 0019 下午 17:53
 * @description:
 */
public class A_Branch_idSink extends AbstractInsertHbase<T01branchinfo> {
    public A_Branch_idSink(){
        tableName = "KLMID:O_XG_T01BRANCHINFO_BRANCH_ID";//HBase中间表名
