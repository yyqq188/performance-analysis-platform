...
/**
 * @author: TSY
 * @create: 2021/10/20 0020 上午 9:38
 * @description:
 */
public class OXTO_Branch_IdSink extends AbstractInsertHbase<T02salesinfo_k> {
    public OXTO_Branch_IdSink(){
        tableName = "KLMID:O_XG_T02SALESINFO_K_BRANCH_ID";//HBase中间表名
        rowkeys = new String[]{"branch_id"};//HBase rowkeys
        //POJO主键---HBase列名
