...
/**
 * @author: TSY
 * @create: 2021/10/19 0019 下午 18:28
 * @description:
 */
public class OXTT_Team_Id_ParentSink extends AbstractInsertHbase<T01teaminfo> {
    public OXTT_Team_Id_ParentSink(){
        tableName = "KLMID:O_XG_T01TEAMINFO_TEAM_ID_PARENT";//HBase中间表名
        rowkeys = new String[]{"team_id_parent"};//HBase rowkeys
        //POJO主键---HBase列名
        columnNames = new String[]{"channel_id","team_id"};
