 ...
 */
public class Lcinsured_AppntNo_AddressSink extends AbstractInsertHbase<KLEntity> {

    public Lcinsured_AppntNo_AddressSink() {
        tableName = "KL:LCINSURED_APPNTNO_ADDRESSNO";//HBase中间表名
