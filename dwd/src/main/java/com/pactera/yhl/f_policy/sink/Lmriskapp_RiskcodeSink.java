 ...
 */
public class Lmriskapp_RiskcodeSink extends AbstractInsertHbase<KLEntity>{
    public Lmriskapp_RiskcodeSink(){
        tableName = "KL:LMRISKAPP_RISKCODE";//HBase中间表名
        rowkeys = new String[]{"riskcode"};//HBase rowkeys
        //POJO主键---HBase列名
