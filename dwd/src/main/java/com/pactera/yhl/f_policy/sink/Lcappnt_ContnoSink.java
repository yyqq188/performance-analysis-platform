 ...
 * @version 1.0
 * @description:
 * @date 2021/10/12 15:17
 */
public class Lcappnt_ContnoSink extends AbstractInsertHbase<KLEntity>{
    public Lcappnt_ContnoSink(){
        tableName = "KL:LCAPPNT_CONTNO";//HBase中间表名
