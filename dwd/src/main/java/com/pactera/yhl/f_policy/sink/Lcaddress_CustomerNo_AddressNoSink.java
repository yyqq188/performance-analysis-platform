 ...
 */
public class Lcaddress_CustomerNo_AddressNoSink extends AbstractInsertHbase<KLEntity>{

    public Lcaddress_CustomerNo_AddressNoSink(){
        tableName = "KL:LCADDRESS_CUSTOMERNO_ADDRESSNO";//HBase中间表名
        rowkeys = new String[]{"customerno","addressno"};//HBase rowkeys
        //POJO主键---HBase列名
