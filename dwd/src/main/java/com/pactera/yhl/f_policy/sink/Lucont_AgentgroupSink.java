 ...
 * @description:
 * @author: TSY
 * @create: 2021/10/12 0012 下午 15:38
 * @Desc:
 */
public class Lucont_AgentgroupSink extends AbstractInsertHbase<KLEntity>  {
    public Lucont_AgentgroupSink(){
        tableName = "KL:LUCONT_AGENTGROUP";//HBase中间表名
