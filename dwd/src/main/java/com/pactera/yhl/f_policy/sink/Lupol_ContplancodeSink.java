 ...
 * @description:
 * @author: TSY
 * @create: 2021/10/12 0012 下午 13:21
 * @Desc:
 */
public class Lupol_ContplancodeSink extends AbstractInsertHbase<KLEntity>  {
    public Lupol_ContplancodeSink(){
        tableName = "KL:LUPOL_CONTPLANCODE";//HBase中间表名
        rowkeys = new String[]{"contplancode"};//HBase rowkeys
        //POJO主键---HBase列名
        columnNames = new String[]{"polno"};
        columnTableName = "lupol";//表名
    }
    @Override
