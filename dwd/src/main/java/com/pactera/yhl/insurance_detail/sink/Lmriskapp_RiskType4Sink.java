 ...
 * @description:
 * @author: TSY
 * @create: 2021/10/12 0012 下午 15:57
 * @Desc:
 */
public class Lmriskapp_RiskType4Sink extends AbstractInsertHbase<KLEntity>  {
    public Lmriskapp_RiskType4Sink(){
        tableName = "KL:LMRISKAPP_RISKTYPE4";//HBase中间表名
        rowkeys = new String[]{"risktype4"};//HBase rowkeys
        //POJO主键---HBase列名
