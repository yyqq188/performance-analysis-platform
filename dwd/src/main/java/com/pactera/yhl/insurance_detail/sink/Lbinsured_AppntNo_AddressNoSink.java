 ...
 */
public class Lbinsured_AppntNo_AddressNoSink extends AbstractInsertHbase<KLEntity>{
    public Lbinsured_AppntNo_AddressNoSink(){
        tableName = "KL:LBINSURED_APPNTNO_ADDRESSNO";//HBase中间表名
