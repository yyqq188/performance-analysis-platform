 ...
 */
public class Lupol_PrtnoSink extends AbstractInsertHbase<KLEntity>{
    public Lupol_PrtnoSink(){
        tableName = "KL:LUPOL_PRTNO";//HBase中间表名
        rowkeys = new String[]{"prtno"};//HBase rowkeys
        //POJO主键---HBase列名
