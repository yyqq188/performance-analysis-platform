 ...
 * @description:
 * @author: TSY
 * @create: 2021/10/12 0012 下午 15:59
 * @Desc:
 */
public class Lmriskapp_RiskType3Sink extends AbstractInsertHbase<KLEntity>  {
    public Lmriskapp_RiskType3Sink(){
        tableName = "KL:LMRISKAPP_RISKTYPE3";//HBase中间表名
        rowkeys = new String[]{"risktype3"};//HBase rowkeys
        //POJO主键---HBase列名
        columnNames = new String[]{"riskcode"};
        columnTableName = "lmriskapp";//表名
    }
    @Override
    public void handle(KLEntity klEntity, Context context, HTable table) throws Exception {
        lmriskapp value = (lmriskapp)  klEntity;
