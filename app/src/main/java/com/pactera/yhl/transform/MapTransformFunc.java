...
// * @Desc
// */
//public class MapTransformFunc extends RichMapFunction<String, KLEntity> {
//    private static final Logger logger = LoggerFactory.getLogger(MapTransformFunc.class);
//
//    @Override
