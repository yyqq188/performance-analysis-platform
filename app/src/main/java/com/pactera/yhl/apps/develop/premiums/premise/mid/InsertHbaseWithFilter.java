...
public  class InsertHbaseWithFilter<OUT> extends RichSinkFunction<OUT> {
    ...
    public InsertHbaseWithFilter(String tableName, String[] rowkeys, String[] columnNames, String columnTableName){
...
//        String config_path = "D:\\Users\\Desktop\\pactera\\code_project\\performance-analysis-platform\\app\\src\\main\\resources\\configuration.properties";
    ...
    public  void handle(OUT value, Context context,HTable hTable) throws Exception{
        ...
        try{
            ...
            String riskcode = value.getClass().getField("riskcode").get(value).toString();
            String mainpolno = value.getClass().getField("mainpolno").get(value).toString();
            String polno = value.getClass().getField("polno").get(value).toString();
            if(mainpolno.equals(polno)){
                columnSb.append(riskcode);
                String valueJson = JSON.toJSONString(riskcode);
