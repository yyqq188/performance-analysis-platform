 ...
 * @description: 日期交活动人力
 */
public class ActivitySumStateMap extends RichMapFunction<Tuple3<String,String,String>,Tuple2<String,String>> {
