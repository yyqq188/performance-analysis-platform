 ...
 * @Desc
 */
public class clickhouseSinkSalaryBjlFunction extends AbstractCKSinkSQ<AssessmentResult> {
    public clickhouseSinkSalaryBjlFunction(){
        tableName = "APPLICATION_ASSESSMENT_SALARY_RESULT_FQBJL";
    }
    @Override
