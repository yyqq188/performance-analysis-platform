...
public class AppProductResultHbaseMapFunc extends RichMapFunction<String, String> {
    ...
    public AppProductResultHbaseMapFunc(String tableName) {
    ...
    public String map(String s) throws Exception {
        ApplicationProductResult obj = new ApplicationProductResult();
        ...
        ApplicationProductResult newObj = subEntity(hbaseFields, subField, obj);
    ...
    private ApplicationProductResult subEntity(String[] hbaseFields, String subField, ApplicationProductResult obj) throws Exception {
    ...
    private void setRowkeyValues(String jsonStr, ApplicationProductResult obj) throws Exception {
    ...
    private void setNewDoubleValue(String fieleName, ApplicationProductResult value, Double newValue) throws Exception {
    ...
    private void setNewStringValue(String fieleName, ApplicationProductResult value, String newValue) throws Exception {
        String methodName = "set" + Util.LargerFirstChar(fieleName);
