 ...
 * @Desc
 */
public class clickhouseSinkGeneralBjlFunction extends AbstractCKSinkSQ<GeneralResult> {
    public clickhouseSinkGeneralBjlFunction(){
        tableName = "APPLICATION_ASSESSMENT_GENERAL_RESULT_FQBJL";
    }
    @Override
