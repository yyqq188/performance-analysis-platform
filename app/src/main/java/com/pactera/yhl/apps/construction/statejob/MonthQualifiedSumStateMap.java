 ...
 * @description: 月合格人力
 */
public class MonthQualifiedSumStateMap extends RichMapFunction<Tuple3<String,String,String>,Tuple2<String,String>> {
    ...
    public void open(Configuration parameters) throws Exception {
        sumState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Double>(
                "sumStateMQSSM", String.class, Double.class
        ));

        countState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Integer>(
                "countStateMQSSM", String.class, Integer.class
        ));
    }
