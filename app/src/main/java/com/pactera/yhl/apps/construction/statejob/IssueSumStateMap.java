 ...
 * @description:  日入职出单人力
 */
public class IssueSumStateMap extends RichMapFunction<Tuple3<String,String,String>,Tuple2<String,String>> {
    ...
    public void open(Configuration parameters) throws Exception {
        sumState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Double>(
                "sumStateISSM", String.class, Double.class
        ));

        countState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Integer>(
                "countStateISSM", String.class, Integer.class
        ));
    }
