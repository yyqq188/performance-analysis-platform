...
public abstract class AbstractInsertKafkaSun<OUT> extends RichSinkFunction<OUT> {
...
//        String config_path = "D:\\Users\\Desktop\\pactera\\code_project\\performance-analysis-platform\\app\\src\\main\\resources\\configuration.properties";
    ...
    public void invoke(OUT value, Context context) throws Exception {
        ...
        try{
            ...
            hTable1 = (HTable) connection.getTable(TableName.valueOf(tableName1));
            handle(value,context,hTable,hTable1);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    public abstract void handle(OUT value, Context context,HTable hTable,HTable hTable1) throws Exception;
