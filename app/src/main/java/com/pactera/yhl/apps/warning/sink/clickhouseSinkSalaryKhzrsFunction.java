 ...
 * @Desc
 */
public class clickhouseSinkSalaryKhzrsFunction extends AbstractCKSinkSQ<AssessmentResult> {
    public clickhouseSinkSalaryKhzrsFunction(){
        tableName = "APPLICATION_ASSESSMENT_SALARY_RESULT_FQZRS";
    }
    @Override
