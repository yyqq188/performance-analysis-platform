...
public class Lmriskapp implements KLEntity{
    ...
    public Integer caldigital;
    public String calchomode;
    public Integer riskamntmult;
    public String insuperiodflag;
    public Integer maxendperiod;
    public Integer agelmt;
    public Integer signdatecalmode;
    ...
    public Integer minappntage;
    public Integer maxappntage;
    public Integer maxinsuredage;
    public Integer mininsuredage;
    public BigDecimal appinterest;
    public BigDecimal apppremrate;
